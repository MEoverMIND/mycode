...
class Cheater_Deebo(Player):
    def cheat(self,other_player):
       dice_sum = self.dice
       other_player_sum = other_player.dice
       if sum(self.dice) < sum(other_player.dice):
           self.dice = other_player_sum 
           other_player.dice = dice_sum
